...
<template>
    <div :class="`star_list `" class="star">
        <svg v-for="(star,index) in 5" :key="index" :class="`star_item_${name}`" xmlns="http://www.w3.org/2000/svg" class="star_item"   width="20" height="20" viewBox="0 0 20 20" fill="none">
            <path 
