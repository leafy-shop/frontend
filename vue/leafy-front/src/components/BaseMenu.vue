...
const callCountCart = async () => {
    ...
    let { status, data } = await fetch.getCartCount();
        ...
        <div class="main_menu_container">
            ...
            <div @click="showMenu2 = !showMenu2" class="burger_icon">
                <div>
                    ...
                    <svg v-show="!showMenu2" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                        viewBox="0 0 24 24" fill="none">
                        <path d="M4 18H20M4 6H20H4ZM4 12H20H4Z" stroke="#212121" stroke-width="2" stroke-linecap="round"
            ...
            <div class="element_service">
                ...
                <div class="service_container_search">
                    <label for="search">
                        <svg @click="goShop" width="20" height="20" viewBox="0 0 20 20" fill="none"
                            xmlns="http://www.w3.org/2000/svg" class="search_icon">
                            <mask id="mask0_2745_19829" style="mask-type:luminance" maskUnits="userSpaceOnUse" x="1"
                                y="1" width="17" height="17">
                                <path fill-rule="evenodd" clip-rule="evenodd"
                                    d="M1.6665 1.6665H17.8972V17.8973H1.6665V1.6665Z" fill="white" />
                            </mask>
                            <g mask="url(#mask0_2745_19829)">
                                <path fill-rule="evenodd" clip-rule="evenodd"
                                    d="M9.78234 2.9165C5.9965 2.9165 2.9165 5.99567 2.9165 9.7815C2.9165 13.5673 5.9965 16.6473 9.78234 16.6473C13.5673 16.6473 16.6473 13.5673 16.6473 9.7815C16.6473 5.99567 13.5673 2.9165 9.78234 2.9165ZM9.78234 17.8973C5.30734 17.8973 1.6665 14.2565 1.6665 9.7815C1.6665 5.3065 5.30734 1.6665 9.78234 1.6665C14.2573 1.6665 17.8973 5.3065 17.8973 9.7815C17.8973 14.2565 14.2573 17.8973 9.78234 17.8973Z"
                                    fill="#BDBDBD" />
                            </g>
                            <mask id="mask1_2745_19829" style="mask-type:luminance" maskUnits="userSpaceOnUse" x="14"
                    ...
                    <svg @click="" width="24" height="24" viewBox="0 0 24 24" fill="none"
                        xmlns="http://www.w3.org/2000/svg" class="search_icon_2">
                        <path fill-rule="evenodd" clip-rule="evenodd"
                            d="M17 10.5C17 14.09 14.09 17 10.5 17C6.91 17 4 14.09 4 10.5C4 6.91 6.91 4 10.5 4C14.09 4 17 6.91 17 10.5Z"
                ...
                <button @click="goCartList" class="cart_b">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                        <path fill-rule="evenodd" clip-rule="evenodd"
                            d="M10.5 17.9928C9.672 17.9928 9 18.6648 9 19.4928C9 20.3208 9.672 20.9928 10.5 20.9928C11.328 20.9928 12 20.3208 12 19.4928C12 18.6648 11.328 17.9928 10.5 17.9928Z"
                            fill="#252525" />
                        <path fill-rule="evenodd" clip-rule="evenodd"
                            d="M17.5 17.9928C16.672 17.9928 16 18.6648 16 19.4928C16 20.3208 16.672 20.9928 17.5 20.9928C18.328 20.9928 19 20.3208 19 19.4928C19 18.6648 18.328 17.9928 17.5 17.9928Z"
                            fill="#252525" />
                        <path
                            d="M3 5H5.331C6.297 5 7.126 5.691 7.299 6.642L8.701 14.358C8.874 15.309 9.703 16 10.669 16H17.494C18.386 16 19.17 15.41 19.416 14.553L20.961 9.181C21.136 8.572 20.707 7.955 20.074 7.908L8 7"
                            stroke="#252525" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                    </svg> ({{ countCart + addCount }})
                </button>
                <!-- profile -->
                ...
                <!-- user profile -->
                <button @click="showOption = !showOption" v-else class="user_profile">
                    <!--@click="goProfile(keyPass.id)"-->
                ...
                <div class="link_list">
                    <button @click="goHome" name="home">
                        ...
                        <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" clip-rule="evenodd"
                                d="M18.9755 8.11309L13.9755 3.74209C12.8445 2.75309 11.1555 2.75309 10.0245 3.74209L5.02451 8.11309C3.99951 9.00909 3.99951 10.1431 3.99951 11.0071V16.0031C3.99951 19.0011 4.99951 20.0001 7.99951 20.0001H15.9995C18.9995 20.0001 19.9995 19.0011 19.9995 16.0031V11.0071C19.9995 10.1431 19.9995 9.00909 18.9755 8.11309Z"
                                stroke="#212121" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M9 16H15" stroke="#212121" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round" />
                        </svg>
                        <h3> Home</h3>
                    </button>
                    <button @click="goShop" name="shop">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none">
                            <path fill-rule="evenodd" clip-rule="evenodd"
                                d="M16.776 9.52449C16.868 9.32349 17.133 9.32349 17.224 9.52449C17.619 10.3885 18.492 10.9925 19.5 10.9925V10.9925C20.875 10.9925 22 9.86749 22 8.49249V8.49249V8.49249C22 7.50649 21.441 5.87549 21 4.99249C21 4.99249 20 2.99249 18.764 2.99249H5.236C4 2.99249 3 4.99249 3 4.99249C2.559 5.87549 2 7.50649 2 8.49249V8.49249C2 9.86749 3.125 10.9925 4.5 10.9925V10.9925C5.508 10.9925 6.381 10.3885 6.776 9.52449C6.868 9.32349 7.133 9.32349 7.224 9.52449C7.619 10.3885 8.492 10.9925 9.5 10.9925V10.9925C10.508 10.9925 11.381 10.3885 11.776 9.52449C11.868 9.32349 12.133 9.32349 12.224 9.52449C12.619 10.3885 13.492 10.9925 14.5 10.9925V10.9925C15.508 10.9925 16.381 10.3885 16.776 9.52449Z"
                                stroke="#212121" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                            <path
                                d="M4 10.9928V16.9928C4 19.9928 5 20.9928 8 20.9928H16C19 20.9928 20 19.9928 20 16.9928V10.9928"
                                stroke="#212121" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                            <path fill-rule="evenodd" clip-rule="evenodd"
                                d="M15 20.9928H9V17.9928C9 16.8878 9.895 15.9928 11 15.9928H13C14.105 15.9928 15 16.8878 15 17.9928V20.9928Z"
                                stroke="#212121" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M7 8.9928L8 2.9928" stroke="#212121" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round" />
                            <path d="M17 8.9928L16 2.9928" stroke="#212121" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round" />
                            <path d="M12 8.9928V2.9928" stroke="#212121" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round" />
                        </svg>
                        <h3> Shop</h3>
                    </button>
                    ...
                    <button @click="validation.clickingTest('link about')" name="about">
                        ...
                        <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M12 15.7463V11.7993" stroke="#212121" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round" />
                            <path fill-rule="evenodd" clip-rule="evenodd"
                                d="M21 12C21 16.971 16.971 21 12 21C7.029 21 3 16.971 3 12C3 7.029 7.029 3 12 3C16.971 3 21 7.029 21 12Z"
                                stroke="#212121" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                            <path fill-rule="evenodd" clip-rule="evenodd"
                                d="M12 8C11.448 8 11 8.448 11 9C11 9.552 11.448 10 12 10C12.552 10 13 9.552 13 9C13 8.448 12.552 8 12 8Z"
                                fill="#212121" />
                        </svg>
                        <h3> About</h3>
                    </button>
...
.cart_b svg:hover path:nth-child(1),
