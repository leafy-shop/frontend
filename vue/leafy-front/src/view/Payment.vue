...
@media (width<=432px){
  ...
  /* payment */
  .wrapper_payment{
    padding: min(1.852dvw,8px) 0px min(4.63dvw,20px) 0px;
  }
  .payment{
  ...
  .method_list button{
    width: min(16.667dvw,72px);
    height: min(8.333dvw,36px);
    border: min(0.231dvw,1px) solid #EEEEEE;
    border-radius:min(0.926dvw,4px) ;
