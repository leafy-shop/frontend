...
const goAdd=()=>myRouter.push({name:'Address_AS_add'})
        ...
        <div class="container_address">
            <div class="address_list">
                <div class="address_item">
                        ...
                        <!-- discription -->
                        <p>
                            King Mongkut’s University of Technology Thonburi (KMUTT), 126 Pracha Uthit Rd, Bang Mot, Thung Khru, Bangkok 10140
                        </p>                 
                </div>
            </div>
        </div>
