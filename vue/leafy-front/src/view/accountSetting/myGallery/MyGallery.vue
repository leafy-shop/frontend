...
<template>
    <div class="wrapper_my_gallery">
        <div class="my_gallery">
            ...
            <!-- sort -->
            <BaseGallerySort name="my_gallery_sort" :is-setting="true" />
            <!-- <div class="sort_list">
            ...
            <div class="wrapper_content">
                ...
                <div class="gallery_list">
                    <!-- gallery item -->
                    <div v-for="(gallery,index) of 5" :key="index" class="gallery_item">
                        <!-- img -->
                        <div class="gallery_img">
                            <img src="../../../assets/home_p/home_design_content_tropical.png" alt="gallery_img">
                        </div>
                        <!-- name -->
                        <div class="gallery_name">
                            <h6>
                                Project Name Lorem ipsum dasdfasdfasfdolor sit amet consectetur.
                            </h6>
                            <p>
        ...
        <BaseMovePage name="my_gallery" :current-page="1" :total-amount-item="10" />
    </div>
</template>
<style scoped>
*{
